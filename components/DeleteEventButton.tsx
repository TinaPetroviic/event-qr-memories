...
export function DeleteEventButton({ eventId }: { eventId: string }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={isPending}
      className="inline-flex items-center gap-1.5 rounded-full border border-red-300 px-5 py-2 text-sm font-medium text-red-700 transition hover:bg-red-50 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-60"
    >
